...
# Select only measurements done in April
FILTER_FILTERFILENAME_ONLY1010="1010_$FILTER_FILTEREDFILENAME"
log "Filtering on the date of 10/10, writing to $CLEANER_FILTERFILENAME_ONLY1010"
grep '\-10\-10' $CLEANER_BAREDATAFILENAME > $FILTER_FILTERFILENAME_ONLY1010
